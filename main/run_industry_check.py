...
# Ensure we can import from the `scans/` folder.
# This assumes the script is running from source/
...
from scans.fundamental_scanner import get_nifty_tickers
from scans.fundamentals.config import USER_AGENTS, MARKET_INDUSTRIES_URL
