...
# Path Resolution
# Assuming this file is at root/scans/fundamentals/utils.py
_FUNDAMENTALS_DIR = Path(__file__).resolve().parent
_SOURCE_DIR = _FUNDAMENTALS_DIR.parent.parent / "source"
...
def get_nifty_tickers(
    ...
    *,
    ...
    try:
        ...
        pass # In case adapters are not available or different requests version
