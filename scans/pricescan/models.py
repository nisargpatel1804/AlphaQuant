...
class TickerPriceScanData:
    ...
    # NEW STRUCTURE: Dict[CategoryName, {'signal': str, 'scans': List[Dict]}]
    categories: Dict[str, Any]

    # Legacy/Summary metadata (counts/coverage). Optional so older JSON remains compatible.
    scan_summary: Dict[str, Any] = field(default_factory=dict)
    
    # Optional field for backward compatibility if needed, though 'categories' replaces it.
    scan_results: Dict[str, List[Dict[str, Any]]] = field(default_factory=dict)